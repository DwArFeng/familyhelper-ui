    ...
    <el-tabs class="tabs-panel" v-model="tabs.activeName" tab-position="left">
      <el-tab-pane name="itemInfo" label="信息">
        <item-info-panel
          ...
          @onCoverPropertyUpdated="handleItemCoverUpdated"
...
import ItemInfoPanel from '@/views/items/assetsManagement/assetBom/ItemInfoPanel.vue';
import ItemFilePanel from '@/views/items/assetsManagement/assetBom/ItemFilePanel.vue';
...
export default {
  ...
  methods: {
    ...
    handleItemCoverUpdated() {
      this.$emit('onItemCoverUpdated');
    },
    handleItemFileUpdated() {
    ...
    handlePanelFloatyButtonClicked(type) {
      ...
      switch (type) {
        case 0:
          this.panelFloaty.title = '信息浮动窗口';
          break;
        case 1:
          this.panelFloaty.title = '资料浮动窗口';
          break;
        case 2:
          this.panelFloaty.title = '参数浮动窗口';
          break;
        default:
