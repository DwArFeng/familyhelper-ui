  ...
  methods: {
      ...
      resolveResponse(this, childForAccountBookDescDisp(
        ...
        .then((res) => {
          ...
          if (res.current_page > res.total_pages && res.total_pages > 0) {
            return resolveResponse(this, childForAccountBookDescDisp(
              this.parentSelection.accountBookId, this.currentPage, this.pageSize,
            ));
          }
    ...
    handleEntityDelete(index, entity) {
      this.$confirm('此操作将永久删除此条记录。<br>是否继续?',
        ...
        .then(() => resolveResponse(this, remove(entity.key.long_id)))
        .then(() => {
          this.$message({
            showClose: true,
            message: '记录删除成功',
