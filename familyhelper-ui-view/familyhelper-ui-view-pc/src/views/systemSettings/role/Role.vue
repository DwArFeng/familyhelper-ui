...
export default {
  ...
  methods: {
    ...
    lookupAllRole() {
      resolveResponse(
        this, allRole(this.roleTablePanel.currentPage, this.roleTablePanel.pageSize),
      )
        .then((res) => {
          // 当查询的页数大于总页数，自动查询最后一页。
          if (res.current_page > res.total_pages && res.total_pages > 0) {
            return resolveResponse(
              this, allRole(res.total_pages, this.roleTablePanel.pageSize),
            );
          }
    ...
    handleRoleCreate() {
      resolveResponse(this, insertRole(
    ...
    handleRoleEdit() {
      Promise.resolve()
        ...
        .then((res) => resolveResponse(this, updateRole(
          this.roleMaintainDialog.anchorEntity.key.string_id,
          this.roleMaintainDialog.anchorEntity.name,
    ...
    handleRoleDelete(node, entity) {
      ...
      this.checkInfluenced(roleKeyToDelete)
        ...
        .then((res) => resolveResponse(this, removeRole(roleKeyToDelete))
          .then(() => Promise.resolve(res)))
        .then((res) => {
    ...
    checkInfluenced(roleKey) {
      return resolveResponse(this, childForRole(roleKey, 0, 99999))
    ...
    handlePexpCreate() {
      ...
      this.checkInfluenced(roleKey)
        ...
        .then((res) => resolveResponse(this, insertPexp(
          '',
          roleKey,
    ...
    handlePexpEdit() {
      ...
      this.checkInfluenced(roleKey)
        ...
        .then((res) => resolveResponse(this, updatePexp(
    ...
    handlePexpDelete(node, entity) {
      ...
      return this.checkInfluenced(roleKey)
        ...
        .then((res) => resolveResponse(this, removePexp(pexpKeyToDelete))
          .then(() => Promise.resolve(res)))
        .then((res) => {
          this.$message({
            showClose: true,
