 ...
 * 类型的参数。
 */
const ARGS_TYPE: string[] = ['mobile', 'login', 'background', 'type']
/**
 * 图片的参数。
 */
const ARGS_IMAGE: string[] = ['mobile', 'login', 'background', 'image']
/**
 * 图片列表的参数。
 */
const ARGS_IMAGE_LIST: string[] = ['mobile', 'login', 'background', 'image_list']
