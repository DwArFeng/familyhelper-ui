    ...
    >
      <template v-slot:west>
        <user-list-panel
          ...
          @on-current-changed="handleUserListCurrentChanged"
        />
      </template>
      <template v-slot:default>
        ...
        <account-edit-panel
          ...
          @on-account-property-updated="handleAccountPropertyUpdated"
        />
      </template>
    </root-border-layout-panel>
  </div>
...
const UPSC_ACCOUNT_EDIT_PANEL = 'ui_preference.mobile.system_settings.account.account_edit_panel'
