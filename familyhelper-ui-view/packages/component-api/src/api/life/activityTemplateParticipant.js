...
export function inspect(activityTemplateKey, userKey) {
    return get('life', `activity-template-participant/${activityTemplateKey}%26${userKey}/`, {});
}

export function inspectDisp(activityTemplateKey, userKey) {
    return get('life', `activity-template-participant/${activityTemplateKey}%26${userKey}/disp/`, {});
}
