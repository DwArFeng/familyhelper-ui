  ...
  <div class="note-management-container">
    ...
    >
      ...
      <template v-slot:default>
        <placeholder-panel v-show="noteTreeCurrentItem === null" text="请选择节点或项目" />
        <node-edit-panel
...
import NoteBookIndicator from '@/views/nodes/elementPlus/note/noteBook/NoteBookIndicator.vue'
