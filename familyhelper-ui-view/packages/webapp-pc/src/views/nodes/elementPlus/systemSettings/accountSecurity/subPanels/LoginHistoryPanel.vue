...
import LoginHistoryInspectDialog from '@/views/nodes/elementPlus/systemSettings/accountSecurity/subDialogs/LoginHistoryInspectDialog.vue'
...
function loginHistoryTableResponseCodeFormatter(row: LoginHistory, column: any): string {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  const value: LoginResponseCode = (row as any)[column.property] as LoginResponseCode
  switch (value) {
    case 0:
      return '通过'
    case 10:
