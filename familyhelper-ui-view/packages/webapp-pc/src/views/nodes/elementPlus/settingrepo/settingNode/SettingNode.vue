...
import SettingNodeInitializeDialog from '@/views/nodes/elementPlus/settingrepo/settingNode/subDialogs/SettingNodeInitializeDialog.vue'
...
// -----------------------------------------------------------配置节点表格处理-----------------------------------------------------------
const SETTING_NODE_TYPE_SPACE: SettingNodeType[] = [0, 1, 2, 3, 4]
