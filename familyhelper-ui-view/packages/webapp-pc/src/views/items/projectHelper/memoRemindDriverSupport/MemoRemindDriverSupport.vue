<template>
  <div class="memo-remind-driver-support-container">
    <border-layout-panel
...
import { all } from '@dwarfeng/familyhelper-ui-component-api/src/api/project/memoRemindDriverSupport';
import resolveResponse from '@/util/response';

export default {
  name: 'MemoRemindDriverSupport',
  components: {
...
<style scoped>
.memo-remind-driver-support-container {
  height: 100%;
  width: 100%;
}
