<template>
  <div class="asset-catalog-container">
    ...
    <entity-maintain-dialog
      ...
      @onEntityCreate="handleAssetCatalogCreate"
      @onEntityEdit="handleAssetCatalogEdit"
    >
    ...
    <permit-maintain-dialog
      ...
      :asset-catalog-id="permitMaintainDialog.assetCatalogId"
    />
  </div>
</template>
...
} from '@dwarfeng/familyhelper-ui-component-api/src/api/assets/assetCatalog';
    ...
    handleItemToPermit(index, item) {
      Promise.resolve(item)
        .then((res) => {
          ...
          this.permitMaintainDialog.assetCatalogId = item.key.long_id;
