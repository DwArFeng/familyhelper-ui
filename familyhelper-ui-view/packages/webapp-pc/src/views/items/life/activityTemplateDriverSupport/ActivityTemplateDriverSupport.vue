<template>
  <div class="activity-template-driver-support-container">
    <border-layout-panel
...
import {
  all,
} from '@dwarfeng/familyhelper-ui-component-api/src/api/life/activityTemplateDriverSupport';
import resolveResponse from '@/util/response';

export default {
  name: 'ActivityTemplateDriverSupport',
  components: {
...
<style scoped>
.activity-template-driver-support-container {
  height: 100%;
  width: 100%;
}
