...
} from '@dwarfeng/familyhelper-ui-component-api/src/api/notify/routerInfo';
import {
  exists as routerSupportExists,
} from '@dwarfeng/familyhelper-ui-component-api/src/api/notify/routerSupport';
import { resetRoute } from '@dwarfeng/familyhelper-ui-component-api/src/api/notify/reset';
      ...
      resolveResponse(allNotifySetting(this.west.table.currentPage, this.west.table.pageSize))
        .then((res) => {
          ...
          if (res.current_page > res.total_pages && res.total_pages > 0) {
            return resolveResponse(allNotifySetting(res.total_pages - 1, this.west.table.pageSize));
          }
