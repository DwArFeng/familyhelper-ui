<template>
  <div class="lazy-tree-node-row">
    ...
    <div v-if="node.expanded && node.loaded && !node.isLeaf" class="tree-children" role="group">
      <lazy-tree-node-row
        ...
        @itemInspect="(_item: CT, _node: NativeTreeNode<CT>) => $emit('itemInspect', _item, _node)"
        @itemEdit="(_item: CT, _node: NativeTreeNode<CT>) => $emit('itemEdit', _item, _node)"
        @itemDelete="(_item: CT, _node: NativeTreeNode<CT>) => $emit('itemDelete', _item, _node)"
      >
...
defineOptions({
  name: 'LazyTreeNodeRow',
})

// region Props 定义

type Props = {
  node: NativeTreeNode<CT>
...
type Emits = {
  (e: 'toggleExpand', node: NativeTreeNode<CT>): void
  (e: 'select', node: NativeTreeNode<CT>): void
  (e: 'operateHover', value: boolean): void
  (e: 'itemInspect', item: CT, node: NativeTreeNode<CT>): void
  (e: 'itemEdit', item: CT, node: NativeTreeNode<CT>): void
  (e: 'itemDelete', item: CT, node: NativeTreeNode<CT>): void
}
