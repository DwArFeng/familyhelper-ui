      ...
      <template #default="{ dockStatus }">
        ...
        >
          <el-button
            ...
            class="button"
            size="small"
            :type="headerToolShownStatus ? 'primary' : 'info'"
            @click="toggleHeaderShown"
          >
            <i class="iconfont">&#xffcf;</i>
          </el-button>
          <el-button
            v-if="showWestToolButton"
            class="button"
            size="small"
            :type="westToolShownStatus ? 'primary' : 'info'"
            @click="toggleWestShown"
          >
            <i class="iconfont">&#xffce;</i>
          </el-button>
          <el-button
            v-if="showEastToolButton"
            class="button"
            size="small"
            :type="eastToolShownStatus ? 'primary' : 'info'"
            @click="toggleEastShown"
          >
            <i class="iconfont">&#xffcc;</i>
          </el-button>
          <el-button
            v-if="showSouthToolButton"
            class="button"
            size="small"
            :type="footerToolShownStatus ? 'primary' : 'info'"
            @click="toggleFooterShown"
          >
            <i class="iconfont">&#xffcd;</i>
          </el-button>
          <el-button
            v-if="fullScreenToolVisible"
            class="button"
            size="small"
            :type="fullScreen ? 'primary' : 'info'"
...
.root-floaty-tool__inner :deep(.button) {
  flex: 0 0 auto;
  width: 28px;
  height: 28px;
  min-width: 28px;
